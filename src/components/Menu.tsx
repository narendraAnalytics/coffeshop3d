...
const MENU_ITEMS = [
  ...
  {
    name: 'Cappuccino',
    description: 'A classic Italian espresso crowned with equal parts velvety steamed milk and thick, airy foam.',
    tags: ['Hot', 'Frothy', 'Classic'],
    videoSrc: '/videos/Cappuccino.mp4',
    price: '₹300',
  },
  {
    name: 'Cafe Latte',
    description: 'Smooth espresso blended with generous steamed milk and a light layer of foam — rich, mellow, and comforting.',
    tags: ['Hot', 'Milky', 'Smooth'],
    videoSrc: '/videos/Cafelatte.mp4',
    price: '₹320',
  },
  {
    name: 'Flat White',
    description: 'A double ristretto with a thin layer of velvety microfoam — intense espresso flavour with silky smoothness.',
    tags: ['Hot', 'Intense', 'Velvety'],
    videoSrc: '/videos/FlatWhite.mp4',
    price: '₹320',
  },
  {
    name: 'Mocha',
    description: 'Espresso meets rich chocolate in an indulgent blend of bold coffee and smooth cocoa, topped with whipped cream.',
    tags: ['Hot', 'Chocolatey', 'Indulgent'],
    videoSrc: '/videos/Mochacoffe.mp4',
    price: '₹350',
  },
  {
    name: 'Frappuccino',
